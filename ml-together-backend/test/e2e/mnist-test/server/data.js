...
const fetchOnceAndSaveToDiskWithBuffer = function (filename) {
...
const loadHeaderValues = function (buffer, headerLength) {
...
const loadImages = async function (filename) {
...
const loadLabels = async function (filename) {
...
class MnistDataset {
     ...
     */
    getTrainData(startIndex, endIndex) {

        return this.getData_(true, startIndex, endIndex);
    }

    getTestData() {

        return this.getData_(false, 0, this.testSize);
    }

    /**
     * startIndex is inclusive
     * endIndex is exclusive
     * @param {boolean} isTrainingData
     * @param {Number} startIndex
     * @param {Number} endIndex
     */
    getData_(isTrainingData, startIndex, endIndex) {
